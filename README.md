...
- [JnyJny/busylight](https://github.com/JnyJny/busylight) - Control USB connected presence lights from multiple vendors via the command-line or web API. (2 days ago)
...
- [TandoorRecipes/recipes](https://github.com/TandoorRecipes/recipes) ([1.4.4](https://github.com/TandoorRecipes/recipes/releases/tag/1.4.4), 2 weeks ago) - Application for managing recipes, planning meals, building shopping lists and much much more!
