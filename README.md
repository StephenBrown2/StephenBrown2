...
- [python-poetry/poetry](https://github.com/python-poetry/poetry) ([1.1.0rc1](https://github.com/python-poetry/poetry/releases/tag/1.1.0rc1), today) - Python dependency management and packaging made easy.
- [encode/httpx](https://github.com/encode/httpx) ([0.15.4](https://github.com/encode/httpx/releases/tag/0.15.4), today) - A next generation HTTP client for Python. 🦋
