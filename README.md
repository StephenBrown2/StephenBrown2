...
- [toolkit-for-ynab/toolkit-for-ynab](https://github.com/toolkit-for-ynab/toolkit-for-ynab) - A general purpose YNAB enhancing browser extension for Chrome and Firefox. Have it your way! (1 day ago)
...
- [rockstor/rockstor-dev-env](https://github.com/rockstor/rockstor-dev-env) - Vagrant &amp; Ansible based developer environment intended to assist with initial source build setups. (3 weeks ago)
...
- [golangci/golangci-lint](https://github.com/golangci/golangci-lint) ([v1.40.1](https://github.com/golangci/golangci-lint/releases/tag/v1.40.1), 2 weeks ago) - Fast linters Runner for Go
- [samuelcolvin/pydantic](https://github.com/samuelcolvin/pydantic) ([v1.8.2](https://github.com/samuelcolvin/pydantic/releases/tag/v1.8.2), 2 weeks ago) - Data parsing and validation using Python type hints
- [encode/httpx](https://github.com/encode/httpx) ([0.18.1](https://github.com/encode/httpx/releases/tag/0.18.1), 4 weeks ago) - A next generation HTTP client for Python. 🦋
