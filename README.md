...
- [golangci/golangci-lint](https://github.com/golangci/golangci-lint) ([v1.44.0](https://github.com/golangci/golangci-lint/releases/tag/v1.44.0), today) - Fast linters Runner for Go
- [TandoorRecipes/recipes](https://github.com/TandoorRecipes/recipes) ([1.0.5.1](https://github.com/TandoorRecipes/recipes/releases/tag/1.0.5.1), today) - Application for managing recipes, planning meals, building shopping lists and much much more!
