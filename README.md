...
- [hashicorp/packer-plugin-vmware](https://github.com/hashicorp/packer-plugin-vmware) ([v1.0.9](https://github.com/hashicorp/packer-plugin-vmware/releases/tag/v1.0.9), 5 days ago) - Packer plugin for VMware Builder
- [mgechev/revive](https://github.com/mgechev/revive) ([v1.3.3](https://github.com/mgechev/revive/releases/tag/v1.3.3), 5 days ago) - 🔥 ~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for golint
