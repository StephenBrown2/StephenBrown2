...
- [encode/httpx](https://github.com/encode/httpx) ([0.22.0](https://github.com/encode/httpx/releases/tag/0.22.0), 4 days ago) - A next generation HTTP client for Python. 🦋
- [TandoorRecipes/recipes](https://github.com/TandoorRecipes/recipes) ([1.0.5.2](https://github.com/TandoorRecipes/recipes/releases/tag/1.0.5.2), 5 days ago) - Application for managing recipes, planning meals, building shopping lists and much much more!
