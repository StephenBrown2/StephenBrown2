...
- [TandoorRecipes/recipes](https://github.com/TandoorRecipes/recipes) ([1.2.1](https://github.com/TandoorRecipes/recipes/releases/tag/1.2.1), 2 days ago) - Application for managing recipes, planning meals, building shopping lists and much much more!
- [dimsemenov/PhotoSwipe](https://github.com/dimsemenov/PhotoSwipe) ([v5.2.2](https://github.com/dimsemenov/PhotoSwipe/releases/tag/v5.2.2), 1 month ago) - JavaScript image gallery for mobile and desktop, modular, framework independent
