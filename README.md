...
- [samuelcolvin/pydantic](https://github.com/samuelcolvin/pydantic) ([v1.8](https://github.com/samuelcolvin/pydantic/releases/tag/v1.8), 1 day ago) - Data parsing and validation using Python type hints
- [nightscout/cgm-remote-monitor](https://github.com/nightscout/cgm-remote-monitor) ([14.2.2](https://github.com/nightscout/cgm-remote-monitor/releases/tag/14.2.2), 5 days ago) - nightscout web monitor
