...
- [samuelcolvin/pydantic](https://github.com/samuelcolvin/pydantic) ([v1.9.1](https://github.com/samuelcolvin/pydantic/releases/tag/v1.9.1), 2 days ago) - Data parsing and validation using Python type hints
- [TandoorRecipes/recipes](https://github.com/TandoorRecipes/recipes) ([1.2.6](https://github.com/TandoorRecipes/recipes/releases/tag/1.2.6), 3 days ago) - Application for managing recipes, planning meals, building shopping lists and much much more!
