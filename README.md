...
- [encode/httpx](https://github.com/encode/httpx) ([0.19.0](https://github.com/encode/httpx/releases/tag/0.19.0), 3 days ago) - A next generation HTTP client for Python. 🦋
- [golangci/golangci-lint](https://github.com/golangci/golangci-lint) ([v1.42.0](https://github.com/golangci/golangci-lint/releases/tag/v1.42.0), 5 days ago) - Fast linters Runner for Go
