...
- [golangci/golangci-lint](https://github.com/golangci/golangci-lint) ([v1.40.1](https://github.com/golangci/golangci-lint/releases/tag/v1.40.1), 1 day ago) - Fast linters Runner for Go
- [samuelcolvin/pydantic](https://github.com/samuelcolvin/pydantic) ([v1.8.2](https://github.com/samuelcolvin/pydantic/releases/tag/v1.8.2), 4 days ago) - Data parsing and validation using Python type hints
