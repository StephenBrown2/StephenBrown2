...
- [toolkit-for-ynab/toolkit-for-ynab](https://github.com/toolkit-for-ynab/toolkit-for-ynab) ([v2.37.0](https://github.com/toolkit-for-ynab/toolkit-for-ynab/releases/tag/v2.37.0), 3 days ago) - A general purpose YNAB enhancing browser extension for Chrome and Firefox. Have it your way!
- [golangci/golangci-lint](https://github.com/golangci/golangci-lint) ([v1.45.0](https://github.com/golangci/golangci-lint/releases/tag/v1.45.0), 4 days ago) - Fast linters Runner for Go
- [TandoorRecipes/recipes](https://github.com/TandoorRecipes/recipes) ([1.1.4](https://github.com/TandoorRecipes/recipes/releases/tag/1.1.4), 6 days ago) - Application for managing recipes, planning meals, building shopping lists and much much more!
