...
- [hashicorp/packer-plugin-vmware](https://github.com/hashicorp/packer-plugin-vmware) ([v1.0.10](https://github.com/hashicorp/packer-plugin-vmware/releases/tag/v1.0.10), 2 weeks ago) - Packer plugin for VMware Builder
- [mgechev/revive](https://github.com/mgechev/revive) ([v1.3.4](https://github.com/mgechev/revive/releases/tag/v1.3.4), 3 weeks ago) - 🔥 ~6x faster, stricter, configurable, extensible, and beautiful drop-in replacement for golint
