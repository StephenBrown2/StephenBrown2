...
- [samuelcolvin/pydantic](https://github.com/samuelcolvin/pydantic) ([v1.7.1](https://github.com/samuelcolvin/pydantic/releases/tag/v1.7.1), 2 days ago) - Data parsing and validation using Python type hints
