...
- [python-hyper/h11](https://github.com/python-hyper/h11) - A pure-Python, bring-your-own-I/O implementation of HTTP/1.1 (5 days ago)
...
- [PyCQA/isort](https://github.com/PyCQA/isort) ([5.6.1](https://github.com/PyCQA/isort/releases/tag/5.6.1), 2 days ago) - A Python utility / library to sort imports.
- [encode/httpx](https://github.com/encode/httpx) ([0.16.1](https://github.com/encode/httpx/releases/tag/0.16.1), 2 days ago) - A next generation HTTP client for Python. 🦋
- [python-poetry/poetry](https://github.com/python-poetry/poetry) ([1.1.2](https://github.com/python-poetry/poetry/releases/tag/1.1.2), 4 days ago) - Python dependency management and packaging made easy.
